...
#include <memory>
#include "../../rmsfinalproject/RMS-main/calender.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Calender_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_Calender_t qt_meta_stringdata_Calender = {
    {
QT_MOC_LITERAL(0, 8) // "Calender"
...
const QMetaObject Calender::staticMetaObject = { {
    ...
    qt_meta_stringdata_Calender.offsetsAndSize,
    qt_meta_data_Calender,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Calender_t
, QtPrivate::TypeAndForceComplete<Calender, std::true_type>
...
void *Calender::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Calender.stringdata0))
