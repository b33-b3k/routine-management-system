...
#include <memory>
#include "../../rmsfinalproject/RMS-main/helppage.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_helppage_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_helppage_t qt_meta_stringdata_helppage = {
    {
QT_MOC_LITERAL(0, 8) // "helppage"
...
const QMetaObject helppage::staticMetaObject = { {
    ...
    qt_meta_stringdata_helppage.offsetsAndSize,
    qt_meta_data_helppage,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_helppage_t
, QtPrivate::TypeAndForceComplete<helppage, std::true_type>
