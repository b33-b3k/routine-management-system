...
#include <memory>
#include "../../rmsfinalproject/RMS-main/aboutpage.h"
...
struct qt_meta_stringdata_aboutpage_t {
    const uint offsetsAndSize[2];
    char stringdata0[10];
};
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_aboutpage_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_aboutpage_t qt_meta_stringdata_aboutpage = {
    {
...
const QMetaObject aboutpage::staticMetaObject = { {
    ...
    qt_meta_stringdata_aboutpage.offsetsAndSize,
    qt_meta_data_aboutpage,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_aboutpage_t
...
void *aboutpage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_aboutpage.stringdata0))
